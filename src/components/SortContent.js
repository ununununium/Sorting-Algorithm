...
var DEFAULT_BARS = [85, 35, 65, 90, 45, 50, 75, 80];

var BORDER_COLOR_RANGE = ["rgba(227,168,255,0)", "rgba(227,168,255,1)"];
const BAR_COLOR_RANGE = ["rgba(87,117,255,0.3)", "rgba(87,117,255,1)"];

const SortContent = ({ sortAlgo, scene }) => {
  WIDTH = Dimensions.get("window").width;
  HEIGHT = 100;
  HEIGHT_RANGE = [HEIGHT * 0.3, HEIGHT];
  BORDER_WIDTH = 5;
  BAR_MARGIN = 5;
  DEFAULT_BARS = [85, 35, 65, 90, 45, 50, 75, 80];
  ...
  function sort() {
    switch (sortAlgo) {
      ...
      case "selectionSort":
        ...
        selectionSort(animSwap, getAnimVal, visit, unvisit, SLEEP_SEC);
        break;
      case "shellSort":
